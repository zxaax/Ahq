...
local toptop = "⇜ أهلين يا روح تعب، هذه أوامري :\n⇜ اختر نوع التوب من الأزرار\n\n⇜ تتصفر اللعبة بعد ↤ "..day.."\n✧"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
bot.sendAudio(msg.chat_id,msg.id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@PST3B")
sleep(1)
